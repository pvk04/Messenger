...
const items = [
	...
	},
	{
		...
		date: "1 minute ago",
		message:
			"test test tset este tset ests ets ets tse testsetststset ts tsetse estes teste stestes tset set tse stest etsetse stets es test e stes teeset tcysdtfgsdfvb f",
		unreadMessages: 2,
		photo: 1,
	},
	{
